...
public class MixedInteger {
	...
	public static void main(String[] args) {
		...
		System.out.println("=======");
		int kk= 10/7;// result is 1.04... but int only take front of comma(,); so output is only 1.
		int klk=10%7;// this is remainder(kalan). so output is 3
		System.out.println(kk+"   "+klk);
